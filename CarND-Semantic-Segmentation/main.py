...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    # Note: softmax_cross_entropy_with_logits is deprecated
    ...
    train_optimize = optimizer.minimize(cross_entropy_loss)

    return logits, train_optimize, cross_entropy_loss
...
def run():
    ...
    with tf.Session() as sess:
        ...
        #FIXME: Not sure why this saving code is not working
